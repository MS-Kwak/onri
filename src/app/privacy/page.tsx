    ...
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      <article className="flex-1 px-6 py-6">
        ...
        <P>
          ...
          중요시하며, 개인정보보호법 등 관련 법령을 준수합니다. 본 방침을
        ...
        <ul className="mb-3 space-y-1 pl-4 text-xs text-foreground/50">
          <li>• 본인인증 정보: 이름, 생년월일, 성별, 휴대전화 번호</li>
          <li>• 계정 정보: 소셜 로그인 식별자(카카오/애플), 이메일</li>
          <li>• 프로필 정보: 닉네임, 지역, 관계 목적</li>
        </ul>
        <P>② 선택 수집 항목:</P>
        <ul className="mb-3 space-y-1 pl-4 text-xs text-foreground/50">
          <li>• 프로필 사진, 자기소개, 관심사, 활동 시간, 키, 몸무게</li>
        ...
        <P>④ 자동 수집 항목:</P>
        <ul className="mb-3 space-y-1 pl-4 text-xs text-foreground/50">
          <li>• 기기 정보(OS, 버전, 기기 식별자), 접속 로그, 서비스 이용 기록</li>
        </ul>

        <S>제2조 (민감정보 처리)</S>
        <P>
          ① 성정체성·성적 지향은 개인정보보호법 제23조에 해당하는
          민감정보로서, 회원가입 시 별도의 명시적 동의를 받아 수집합니다.
          <br />② 민감정보는 매칭 서비스 제공 목적으로만 사용되며, 암호화하여
          저장합니다.
        ...
        <P>
          ① 회원 탈퇴 시 모든 개인정보는 즉시 파기합니다. 단, 관련 법령에
          따라 보존이 필요한 정보는 해당 기간 동안 안전하게 보관 후
          파기합니다:
        </P>
        <ul className="mb-3 space-y-1 pl-4 text-xs text-foreground/50">
        ...
        <P>
          ...
          않습니다.
          <br />② 다만, 이용자가 사전 동의한 경우와 법원의 영장 등 적법한
          절차에 따른 수사기관 요청의 경우는 예외로 합니다.
        ...
        <P>
          위 요청은 서비스 내 설정 또는 고객센터를 통해 처리할 수 있으며,
          요청 접수 후 10일 이내에 처리합니다.
        </P>

        <S>제8조 (아웃팅 방지를 위한 기술적 조치)</S>
        <P>
          ① 성정체성 정보는 DB 내에서 암호화 저장되며, 복호화 키는 별도로
          관리합니다.
